...
**Fig 1.** Overview of the framework pipeline. The pipeline depicted with green arrows shows the synthetic ground truth generation, whereas the pipeline depicted with blue arrows shows the interpolation of sparse matched keypoints and correction to biomechanically plausible displacement field with a 3D residual U-Net.
