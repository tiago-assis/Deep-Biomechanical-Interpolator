...
def get_training_transforms(img_keys, kpts_keys, disp_field_keys, seg_keys, upenn_edema_seg_keys,
    ...
    load_rand_ddf = LoadRandDDFd(keys=disp_field_keys, seed=None)
